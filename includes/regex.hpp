...
inline bool
do_it(Func f, Str str, const RE2& regex, const A&... a)
{
...
inline bool
do_it(Func f, Str str, const RE2& regex)
{
...
bool
full_match(T& full_str, const RE2& regex, A&&... a)
{
  ...
  return do_it(
    RE2::FullMatchN, full_str.c_str(), regex, RE2::Arg(std::forward<A>(a))...);
}

template<typename T, typename... A>
bool
partial_match(T& full_str, const RE2& regex, A&&... a)
{
  if (!check_regex(regex)) {
    return false;
  }

  return do_it(RE2::PartialMatchN,
               full_str.c_str(),
               regex,
...
template<typename T, typename... A>
bool
loop_it(T* input, const RE2& regex, A&&... a)
{
  if (!check_regex(regex)) {
    return false;
  }
